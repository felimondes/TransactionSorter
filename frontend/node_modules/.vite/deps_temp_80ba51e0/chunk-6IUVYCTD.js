...
function addHolePaths(context, holes) {
  ...
  for (let i = 0; i < holes.length; i++) {
    const hole = holes[i];
    if (!(hole == null ? void 0 : hole.shape))
      continue;
...
var CanvasGraphicsAdaptor = class {
  ...
  execute(graphicsPipe, renderable) {
    ...
    for (let i = 0; i < instructions.length; i++) {
      ...
      if (!((_d = shapePath == null ? void 0 : shapePath.shapePrimitives) == null ? void 0 : _d.length))
        continue;
      ...
      for (let j = 0; j < shapePrimitives.length; j++) {
        ...
        if (!(primitive == null ? void 0 : primitive.shape))
          continue;
...
var CanvasStencilMaskPipe = class {
  ...
  execute(instruction) {
    ...
    for (let i = 0; i < instructions.length; i++) {
      ...
      if (!((_c = shapePath == null ? void 0 : shapePath.shapePrimitives) == null ? void 0 : _c.length))
        continue;
      const shapePrimitives = shapePath.shapePrimitives;
      for (let j = 0; j < shapePrimitives.length; j++) {
        const primitive = shapePrimitives[j];
...
//# sourceMappingURL=chunk-6IUVYCTD.js.map

package com.transactionapp.client.steps;
import com.transactionapp.client.dummyobjects.Bucket;
import com.transactionapp.client.apis.BucketService;
import com.transactionapp.client.dummyobjects.Transaction;
import com.transactionapp.client.apis.TransactionService;
...
public class SortTransactionsSteps {
    ...
    public void aTransactionWithSomeInformation() {
        Transaction transaction = transactionService.createTransaction(
                new Transaction("Netto", LocalDate.parse("1999-01-01"), new BigDecimal("100.00")));
